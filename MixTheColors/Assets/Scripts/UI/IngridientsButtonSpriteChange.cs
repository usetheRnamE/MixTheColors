...
namespace UI
{
    public class IngridientsButtonSpriteChange : MonoBehaviour
    {
        ...
        {         
            ...
            spriteRen.sprite = MixerIngridientManager.MIMinstance.ingredientSprites[spriteIndex]; // sets sprite by the following index
        }
